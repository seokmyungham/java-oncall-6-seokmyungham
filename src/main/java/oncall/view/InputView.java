...
public class InputView {
    ...
    public static final String WEEKDAY_MEMBERS_INPUT_PROMPT = "%n평일 비상 근무 순번대로 사원 닉넹미을 입력하세요> ";
    public static final String DAY_OFF_MEMBERS_INPUT_PROMPT = "%n휴일 비상 근무 순번대로 사원 닉네임을 입력하세요> ";
